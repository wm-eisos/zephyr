...
The we_oceanus1ev board is an evaluation board of the Oceanus-I radio module.
It provides support for the STM32WLE5CC ARM CPU and
...
- Oceanus-I, 256KB Flash, 64KB RAM with external antenna
...
Applications for the ``we_oceanus1ev`` board configuration can be built the
...
.. _Oceanus-I radio module website: https://www.we-online.com/katalog/de/OCEANUS-I
.. _STM32WLE5CC website: https://www.st.com/en/microcontrollers-microprocessors/stm32wle5cc.html
