...
static void pads_2511020213301_thread(struct pads_2511020213301_data *data)
{
	while (true) {
...
int pads_2511020213301_init_interrupt(const struct device *dev)
{
	...
	k_thread_create(&data->thread, data->thread_stack,
			CONFIG_WSEN_PADS_2511020213301_THREAD_STACK_SIZE,
			(k_thread_entry_t)pads_2511020213301_thread, data, NULL, NULL,
