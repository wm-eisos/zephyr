...
static void tids_2521020222501_thread(struct tids_2521020222501_data *tids_2521020222501)
{
	while (true) {
...
int tids_2521020222501_init_interrupt(const struct device *dev)
{
	...
	k_thread_create(&data->thread, data->thread_stack,
			CONFIG_WSEN_TIDS_2521020222501_THREAD_STACK_SIZE,
			(k_thread_entry_t)tids_2521020222501_thread, data, NULL, NULL,
